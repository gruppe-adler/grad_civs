            ...
            [
                ["AND I add no crew",
                    ...
                    [
                        ["WHEN I let it reverse",
                            {
                                [_this, [0, -50, 0]] call grad_civs_fnc_reverse;
                                _this
                            },
                            [
                        ...
                        ["WHEN I let it reverse",
                            ...
                            [
                                ["THEN it has indeed reversed after 2s",
                                    {
                                        sleep 4;
                                        [(getPos _this)#1, -20, -1] call grad_testing_fnc_assertBetween;
                                    }
                                ],
                ...
                ["AND I fill the vehicle with people",
                    ...
                    [
                        ["WHEN I let it reverse",
                            {
                                [_this, [0, -20, 0]] call grad_civs_fnc_reverse;
                                _this
                            },
                            [
                                ["THEN it has indeed reversed after 2s",
                                    {
                                        sleep 4;
                                        [(getPos _this)#1, -25, -1] call grad_testing_fnc_assertBetween;
                                    }
                                ],
                                ["THEN it is still moving after 2s",
                                    {
                                ...
                                ["THEN it is close to the target and stopped after 15s",
                                    {
                                        sleep 12;
                                        [(getPos _this)#1, -22, -18] call grad_testing_fnc_assertBetween;
                                        [(getPos _this)#0, -5, 5] call grad_testing_fnc_assertBetween;
                        ...
                        ["WHEN I let it reverse 100m AND abort after 2 seconds",
                            {
                                [_this, [0, -100, 0]] call grad_civs_fnc_reverse;
                                sleep 2;
                                [_this] call grad_civs_fnc_reverse_abort;
                                _this
                            },
                            [
