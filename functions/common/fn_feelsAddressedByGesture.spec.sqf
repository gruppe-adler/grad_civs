private _bAwareOfAGesturing = [
    ...
    {
        params ["_a", "_b"];
        [[_a, vectorDirVisual _a, driver _b] call grad_civs_fnc_feelsAddressedByGesture] call grad_testing_fnc_assertTrue;
    }
];
...
private _bUnawareOfAGesturing = [
    ...
    {
        params ["_a", "_b"];
        [[_a, vectorDirVisual _a, driver _b] call grad_civs_fnc_feelsAddressedByGesture] call grad_testing_fnc_assertFalse;
    }
];
...
["given two units A (on foot) and B",
    [
        ...
        },
        {
            ...
            private _pos = [0, 0, 0];
            private _a = _group createUnit ["C_Man_1", _pos, [], 0, "NONE"];
            private _veh = createVehicle ["C_Kart_01_F", _pos vectorAdd [0, 0, 20], [], 0, "NONE"];
